...
//             lazy_update_Katyusha(w, wold, gold, last_seen, stepSize, lambda, i, ir, jc + idx, x, tau);
...
//             // Update the test point
//             update_test_point_sparse_Katyusha(Xt + jc[idx], w, sigmoid,
//                 sigmoidold, jc[idx + 1] - jc[idx], stepSize, ir + jc[idx], x, tau);
//         }

//         // Update the rest of lazy_updates
//         finish_lazy_updates_Katyusha(w, wold, gold, last_seen, stepSize, lambda, m[k], d, x, tau);
//     }
